-- Update Enrichment Prompt to include Logistics
...
3. Generate "budget_breakdown" OBJECT with integer costs:
   ...
   - "tickets": e.g. 100000
   - "misc": e.g. 50000
4. Generate "logistics" OBJECT (CRITICAL):
   - "arrival_guide": {
...
5. Return the FULL updated JSON matching the complete TripPlan structure.
',
updated_at = NOW()
